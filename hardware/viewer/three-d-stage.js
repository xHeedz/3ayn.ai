...
(() => {
  const stylesheet = `
    ...
    .toolbar button:hover { background: rgba(32, 30, 29, 0.07); }
    .toolbar button:active { background: rgba(32, 30, 29, 0.14); }
    .toolbar button:focus-visible { outline: 2px solid #ec3013; outline-offset: 2px; }
